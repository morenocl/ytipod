...
YOUTUBE_DIR = (DOWNLOAD_DIR / "Youtube").resolve()
PODCAST_DIR = (DOWNLOAD_DIR / "Podcast").resolve()
EPUB_DIR = (DOWNLOAD_DIR / "epubs").resolve()
IPOD_MOUNT = Path(os.getenv("YTIPOD_IPOD_MOUNT", "/media/ipod")).resolve()
IPOD_YOUTUBE_DIR = Path(os.getenv("YTIPOD_IPOD_YOUTUBE_DIR", IPOD_MOUNT / "Youtube")).resolve()
...
IPOD_VIDEO_BITRATE = os.getenv("YTIPOD_IPOD_VIDEO_BITRATE", "450k")
